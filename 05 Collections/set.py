...
remaining=fruits.difference_update(favourite_fruits) # Remove all elements of another set from this set.
print(remaining)
print(fruits)
print("---------------------------------------")
remaining=fruits.difference(favourite_fruits) # Return the difference of two or more sets as a new set.
print(remaining)
print(fruits)